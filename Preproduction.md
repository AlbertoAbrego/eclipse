...
Un juego roguelite de supervivencia donde el jugador explora zonas, derrota enemigos, obtiene objetos y mejoras, desbloquea nuevas clases, armas, modificadores, objetos permanentes entre partidas
...
2. Exploración
3. Batallas (enemigos)
4. Oportunidad que el jugador vuelva a casa (guardar objetos)
5. Jugador muere (pierde inventario)
6. Vuelve a iniciar, pero con objetos guardados
...
Mediante avance en el juego o guardando objetos al volver a casa, es lo que se me ocurre, otra forma podría ser tener puntos de guardado, pero eso sale del estilo roguelite/roguelike.
...
5. 10 tipos de enemigos
6. 1 jefe
7. Sistema de progresion
8. Logros básicos o iniciales
9. Configuracion
10. Guardado
11. Soporte para gamepad/joystick
